  ...
  <div class="min-h-screen bg-black text-zinc-100 antialiased accent-gradient-bg">
    ...
    <div class="mx-auto max-w-4xl px-6 pb-16">
      ...
      <section id="iletisim" class="scroll-mt-8 py-10">
        ...
        <div class="grid max-w-md grid-cols-2 gap-4 sm:max-w-none">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center justify-center gap-2 rounded-xl accent-border-soft bg-zinc-900/80 px-5 py-3 text-sm font-medium accent-text transition-all hover-accent-border hover-accent-bg hover-accent-text accent-shadow-soft"
          >
            {{ link.label }}
          </a>
        </div>
